...
class Lorenz63(SimBase):
    ...
    def __init__(self, sigma: float = 10.0, rho: float = 28.0, beta: float = 8 / 3, dt: float = 0.05) -> None:
        ...
        """
        self.default_parameters = {key: val for key, val in locals().items() if key != "self"}
        ...
        self.dimensions = 3
        # self.default_parameters = {"sigma": 10.0,
        #                            "rho": 28.0,
        #                            "beta": 8/3}

        self.default_starting_point = np.array([0.0, -0.01, 9.0])
...
class Roessler(SimBaseRungeKutta):
    ...
    def __init__(self, a: float | None = None, b: float | None = None, c: float | None = None,
        ...
        Args:
            ...
            dt: Size of time steps.
        """
        self.default_parameters = {"a": 0.2,
                                   "b": 0.2,
                                   "c": 5.7,
                                   "dt": 0.1}

        self.default_starting_point = np.array([-9.0, 0.0, 0.0])
...
#
#
# class SimplestQuadraticChaotic(SimBase):
...
#
#
# class SimplestCubicChaotic(SimBase):
...
#
#
# class SimplestPiecewiseLinearChaotic(SimBase):
